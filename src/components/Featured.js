                ...
                <Grid item xs={12} md={11}>
                    <Box sx={{ height: '60vh' }}>
                        <TabContext value={value}>
                            ...
                            <TabPanel value="1">
                                <Card url2={"https://imdb-api.com/en/API/MostPopularMovies/k_ak9k9uvj"} />
                            </TabPanel>
                            <TabPanel value="2"><Card url2={"https://imdb-api.com/en/API/ComingSoon/k_ak9k9uvj"} /></TabPanel>
                            <TabPanel value="3"><Card url2={"https://imdb-api.com/en/API/InTheaters/k_ak9k9uvj"} /></TabPanel>
                        </TabContext>
                    </Box>
                </Grid>
            </Grid>
