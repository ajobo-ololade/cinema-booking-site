    ...
    return (
        <>
            <Box sx={{ height: '100%', position: "relative" }}>
                ...
                <Box style={{ backgroundImage: `url(${slides[currentIndex].url})`, width: '100%', height: '100%', backgroundPosition: "right", backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}>
                </Box>
                <Box sx={{position:'absolute',top:0,left:0,height:'100%',width:'30%'}} className='tee'>
                    lorem
                </Box>
            </Box>
